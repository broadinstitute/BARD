...
{ 
  ...
  if (browserVersion > 0) 
    auxEv = "<a href='javascript:clickOnNode(\""+this.getID()+"\")' alt=\""+this.desc+"\">" 
  else 
    auxEv = "<a>" 
  ...
  if (this.level>0) 
    if (this.isLastNode) //the last child in the children array 
	    leftSide = leftSide + "<td valign=top>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeName + "' width=16 height=22 border=0 alt=\""+this.desc+"\"></a></td>"
    else 
      leftSide = leftSide + "<td valign=top background=" + ICONPATH + "ftv2vertline.gif>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeName + "' width=16 height=22 border=0 alt=\""+this.desc+"\"></a></td>"
  ...
  if (USEICONS)
  {
    ...
    docW = docW + "<img id='folderIcon" + this.id + "' name='folderIcon" + this.id + "' src='" + this.iconImageSrc() + "' border=0 alt=\""+this.desc+"\"></a>"
  }
  else
  {
	  if (this.prependHTML == "")
        docW = docW + "<img src=" + ICONPATH + "ftv2blank.gif height=2 width=2 alt=\""+this.desc+"\">"
  }
  if (WRAPTEXT)
...
function Item(itemDescription, itemLink, target, altData) // Constructor 
{ 
  // constant data 
...
{ 
  ...
  if (this.level>0) 
    ...
    { 
      leftSide = leftSide + "<td valign=top><img src='" + ICONPATH + "ftv2lastnode.gif' width=16 height=22 alt=\""+this.altTxt+"\"></td>"
    } 
    else 
    { 
      leftSide = leftSide + "<td valign=top background=" + ICONPATH + "ftv2vertline.gif><img src='" + ICONPATH + "ftv2node.gif' width=16 height=22 alt=\""+this.altTxt+"\"></td>"
    } 
  ...
  docW = docW + "<tr>" + leftSide + "<td valign=top>"
  if (USEICONS)
      docW = docW + "<a " + fullLink  + " id=\"itemIconLink"+this.id+"\">" + "<img id='itemIcon"+this.id+"' " + "src='"+this.iconSrc+"' border=0 alt=\""+this.altTxt+"\">" + "</a>"
  else
	  if (this.prependHTML == "")
        docW = docW + "<img src=" + ICONPATH + "ftv2blank.gif height=2 width=3 alt=\""+this.altTxt+"\">"
...
function leftSideHTML(leftSideCoded) {
	...
	for (i=0; i<leftSideCoded.length; i++)
	{
		...
		{
			retStr = retStr + "<td valign=top background=" + ICONPATH + "ftv2vertline.gif><img src='" + ICONPATH + "ftv2vertline.gif' width=16 height=22 alt=\""+this.altTxt+"\"></td>"
		}
		if (leftSideCoded.charAt(i) == "0")
		{
			retStr = retStr + "<td valign=top><img src='" + ICONPATH + "ftv2blank.gif' width=16 height=22 alt=\""+this.altTxt+"\"></td>"
		}
	}
	return retStr
}
...
function gLnk(optionFlags, description, linkData, altData) 
{ 
  var fullLink = "";
  var targetFlag = "";
  var target = "";
  ...
  {
    return oldGLnk(optionFlags, description, linkData, altData)
  }
...
function oldGLnk(target, description, linkData, altData )
{
  var fullLink = "";
  ...
  linkItem = new Item(description, fullLink, altData)   
  return linkItem 
}

...
public interface CapQueries {
	String ASSAY_SUMMARY_BYID = "SELECT A.ASSAY_ID adid, A.ASSAY_STATUS status, A.ASSAY_SHORT_NAME sName, A.ASSAY_NAME name, A.ASSAY_VERSION aVersion, A.ASSAY_TYPE aType, A.DESIGNED_BY designedBy FROM ASSAY A WHERE A.ASSAY_ID= ?";
	String ASSAY_SUMMARY_BYNAME = "SELECT A.ASSAY_ID adid, A.ASSAY_STATUS status, A.ASSAY_SHORT_NAME sName, A.ASSAY_NAME name, A.ASSAY_VERSION aVersion, A.ASSAY_TYPE aType, A.DESIGNED_BY designedBy FROM ASSAY A WHERE A.ASSAY_NAME=?";
	String ASSAY_SEARCH_NAME_STR = "SELECT COUNT(A.ASSAY_NAME) Count FROM ASSAY A where A.ASSAY_NAME LIKE ?";

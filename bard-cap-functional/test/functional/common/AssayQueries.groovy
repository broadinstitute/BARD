...
class AssayQueries {
	...
	final static String ASSAY_CONTEXTS = "SELECT AC.CONTEXT_NAME ContextName FROM ASSAY_CONTEXT AC WHERE AC.ASSAY_ID = ? AND (AC.CONTEXT_GROUP = ? OR AC.CONTEXT_GROUP = ?)";

...
<div class="row-fluid">
    ...
    <table class="table table-condensed">
        ...
        <tr>
            ...
            <th>Structure</th>
            <th>Outcome</th>
             <th><a href="#" rel="tooltip" title="${experimentDataMap?.priorityDescription ?: ''}">${experimentDataMap?.priorityDisplay ?: ""}</a></th>
                ...
                <g:each in="${priorityElement?.concentrationResponseSeries}" var="concRespSeries">
                        ...
                        <table class="table table-striped table-condensed">
                            <thead><tr>
                                <th>
                                    ...
                                    <a href="#" rel="tooltip" title="${concRespSeries?.dictionaryDescription ?: ''}">${concRespSeries.dictionaryLabel}</a>
                                </th>
                                <th>Concentration</th>
                            </tr>
                            </thead>
                    ...
                    <td>
                        <g:each in="${concRespSeries.miscData}" var="miscData">
                            <a href="#" rel="tooltip" title="${miscData?.dictionaryDescription ?: ''}">${miscData.toDisplay()}</a>
                            <br/>
                        </g:each>
                    </td>
                </g:each>

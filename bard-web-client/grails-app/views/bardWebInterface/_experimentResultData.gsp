                            ...
                            <td>
                                <img alt="${concRespMap.title}" title="${concRespMap.title}"
                                     src="${createLink(controller: 'doseResponseCurve', action: 'doseResponseCurve',
                                             params: [sinf: concRespMap.plot.sinf,
                                                     s0: concRespMap.plot.s0,
                                                     slope: concRespMap.plot.slope,
                                                     hillSlope: concRespMap.plot.hillSlope,
                                                     concentrations: concRespMap.plot.concentrations,
                                                     activities: concRespMap.plot.activities,
                                                     yAxisLabel: concRespMap.plot.yAxisLabel,
                                                     xAxisLabel: concRespMap.plot.xAxisLabel,
                                                     yNormMin: concRespMap.plot.yNormMin,
                                                     yNormMax: concRespMap.plot.yNormMax
                                             ])}"/>
                                <br/>

<dl class="dl-horizontal dl-horizontal-wide">
    ...
    %{--<g:each in="${assayAdapter?.annotations}" var="annotation">--}%
        ...
        %{--</g:if>--}%
        %{--<g:if test="${annotation?.context?.key == 'detection method type'}">--}%
            %{--<dt>Detection Method:</dt>--}%
            %{--<dd>${annotation.display}</dd>--}%
        %{--</g:if>--}%
        %{--<g:if test="${annotation?.context?.key == 'detection instrument name'}">--}%
            %{--<dt>Detection Instrument:</dt>--}%
            %{--<dd>${annotation.display}</dd>--}%
        %{--</g:if>--}%
        %{--<g:if test="${annotation?.context?.key == 'assay footprint'}">--}%

<section id="target-info">
    ...
    <g:each in="${targets}" var="target">
        <dl class="dl-horizontal dl-horizontal-wide">
            ...
            <dt>Taxonomic Identifier:</dt><dd>${target.taxId}<a href="http://www.uniprot.org/taxonomy/${target.taxId}" target="_blank">
            ...
            <dt>Accession #:</dt><dd>${target.acc}<a href="http://www.uniprot.org/uniprot/${target.acc}" target="_blank">

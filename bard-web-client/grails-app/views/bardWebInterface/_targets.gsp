                ...
                <g:each in="${targets}" var="target">
                    <dl>
                        ...
                        <dd>Taxonomic Identifier: <a href="http://www.uniprot.org/taxonomy/${target.taxId}" target="_blank">
                            <img src="${resource(dir: 'images', file: 'uniprot_logo.gif')}" alt="Taxonomy" title="Taxonomy"/></a>
                            <a href="http://www.ncbi.nlm.nih.gov/Taxonomy/Browser/wwwtax.cgi?lvl=0&id=${target.taxId}" target="_blank">
                        ...
                        <dd>Accession #: <a href="http://www.uniprot.org/uniprot/${target.acc}" target="_blank">
                            <img src="${resource(dir: 'images', file: 'uniprot_logo.gif')}" alt="Accession" title="Accession Number"/>
                        </a></dd>
                    </dl>
                </g:each>
            </div>

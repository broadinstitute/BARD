...
# run the tests
java -jar test/jasmine/lib/JsTestDriver-1.3.4.b.jar --config test/jasmine/jsTestDriver.conf --port 4224 --browser "$NEW_FIRE_FOX_PATH" --runnerMode DEBUG --tests all --testOutput $OUTPUT_DIR

            ...
            <g:each var="rowCnt" in="${0..(molSpreadSheetData.getRowCount() - 1)}">
                ...
                <g:each var="colCnt" in="${2..(molSpreadSheetData.getColumnCount() - 1)}">
                    <td class="molSpreadSheet" property="var${colCnt}">
                        ...
                        <p><div data-detail-id="drc_${experimentData.sid}" class="drc-popover-link btn btn-link"
                                   data-original-title="${experimentData.hillCurveValue.id}" data-html="true" data-trigger="hover">

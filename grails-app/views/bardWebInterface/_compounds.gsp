        ...
        <g:each var="compoundAdapter" in="${compoundAdapters}">
            <tr>
                ...
                <td>
                    ...
                    <a href="#" class="addCompoundToCart btn btn-mini"
                       data-cart-name="${JavaScriptUtility.cleanup(compoundAdapter.name)}"
                       data-cart-id="${compoundAdapter.pubChemCID}"
                       data-cart-smiles="${compoundAdapter.getStructureSMILES()}">

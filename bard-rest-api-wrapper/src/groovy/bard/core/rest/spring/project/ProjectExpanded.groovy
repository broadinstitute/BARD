...
public class ProjectExpanded extends JsonUtil {
    ...
    @JsonProperty("eids")
    private List<ExperimentSearch> eids = new ArrayList<ExperimentSearch>();
    @JsonProperty("aids")
    private List<Assay> aids = new ArrayList<Assay>();
    ...
    @JsonProperty("eids")
    public List<ExperimentSearch> getEids() {
        return eids;
    }

    @JsonProperty("eids")
    public void setEids(List<ExperimentSearch> eids) {
        this.eids = eids;
    }

    @JsonProperty("aids")
    public List<Assay> getAids() {
        return aids;
    }

    @JsonProperty("aids")
    public void setAids(List<Assay> aids) {
        this.aids = aids;
    }

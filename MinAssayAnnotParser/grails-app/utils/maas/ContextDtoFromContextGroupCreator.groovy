...
class ContextDtoFromContextGroupCreator {
     ...
     * @return
     */
    static ContextDTO create(ContextGroup contextGroup, Row row, Sheet sheet) {
     ...
     */
    private getCellContent(String cellId, Row row, Sheet sheet) {
    ...
    /**
     * Get the correct Row based on
     * the row-number in the cell-ID

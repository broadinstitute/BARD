...
class CompoundSummaryCategorizerUnitSpec  extends Specification {
 ...
 [{"name":"/", "children": [
    ...
    void "test addNewRecord"() {
        ...
        when:
        compoundSummaryCategorizer.addNewRecord(123L,"cell-based format","transporter assay",null,null,null,321L)
        compoundSummaryCategorizer.addNewRecord(456L,"biochemical format","protein-small molecule interaction assay",null,null,null,654L)
        compoundSummaryCategorizer.addNewRecord(666L,"biochemical format","protein-small molecule interaction assay",null,null,null,666L)
        compoundSummaryCategorizer.addNewRecord(667L,"biochemical format","transporter assay",null,null,null,766L)
        compoundSummaryCategorizer.addNewRecord(789L,"single protein format","direct enzyme activity assay",null,null,null,987L)
...
//    }
    ...
    void "test addNewRecord error-checking"() {
        ...
        when:
        compoundSummaryCategorizer.addNewRecord(7L,"", "", "", "", "", 7L)
        compoundSummaryCategorizer.addNewRecord(7L,"", "", "", "", "", 7L)
    ...
    void "test addNewRecord "() {
        ...
        when:
        compoundSummaryCategorizer.addNewRecord(eid,  assayFormat,  assayType,  assayName,  assayCapId,  bardAssayId,capEid)
        compoundSummaryCategorizer.addNewRecord(eid,  assayFormat,  assayType,  assayName,  assayCapId,  bardAssayId,capEid)
        ...
        compoundSummaryCategorizer.totalContents[eid].getCapEid() == capEid
    }

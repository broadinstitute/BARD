...
class OntologyDataAccessServiceIntegrationSpec extends IntegrationSpec {
    ...
    void "test getValueDescriptors with direct Children desc: '#desc' expectedLabels: #expectedLabels"() {
        ...
        "0 children due to null search term"           | []                                | null       | [[leaf: true, elementStatus: Published, label: 'child1']]
        ...
        "1 child ensuring searchTerm trimmed"          | ['child1']                        | ' child'   | [[leaf: true, elementStatus: Published, label: 'child1']]
...
//        "1 child of 2 due to leaf"                     | ['child2']                        | 'child'    | [[elementStatus: Published, label: 'child1'], [elementStatus: Published, label: 'child2']]

...
<div class="control-group  fieldcontain ${hasErrors(bean: assayInstance, field: 'assayShortName', 'error')} required">
	<label class="control-label" for="assayShortName"><g:message code="assay.assayShortName.label" default="Assay Title:" /></label>
	<div class="controls">
		<g:textField name="assayShortName" maxlength="250" required="" value="${assayInstance?.assayShortName}"/>
		<span class="help-inline">
			<g:hasErrors bean="${assayInstance}" field="assayShortName">
				<div class="alert alert-block alert-error fade in">
				<g:eachError bean="${assayInstance}" field="assayShortName">

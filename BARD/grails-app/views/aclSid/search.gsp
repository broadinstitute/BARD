                ...
                <g:form action='aclSidSearch' name='aclSidSearchForm'>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan='3'><g:textField name='sid' size='50' maxlength='255' autocomplete='off'
                                                         value='${sid}'/></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <g:radioGroup name='principal' labels="['', '', '']" values="[1, -1, 0]"
                                          value='${principal}'>
                                <td><%=it.radio%></td>
                            </g:radioGroup>
                        </tr>
                        ...
                        <tr>
                            <td colspan='4'><s2ui:submitButton elementId='search' form='aclSidSearchForm'
            ...
            <g:if test='${searched}'>
                ...
                <div class="list">
                    <table>
                        <thead>
                        <tr>
                            <g:sortableColumn property="sid"
                                              title="${message(code: 'aclSid.sid.label', default: 'SID')}"
                                              params="${queryParams}"/>
                            <g:sortableColumn property="principal"
                                              title="${message(code: 'aclSid.principal.label', default: 'Principal')}"
                                              params="${queryParams}"/>
                        </tr>
                        </thead>
                        ...
                        <g:each in="${results}" status="i" var="aclSid">
                            <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                <td><g:link action="edit"
                                            id="${aclSid.id}">${fieldValue(bean: aclSid, field: "sid")}</g:link></td>

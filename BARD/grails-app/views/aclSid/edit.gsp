            ...
            <s2ui:form width='100%' height='275' elementId='formContainer'
                ...
                <g:form action='update' name='aclSidEditForm'>
                            ...
                            <tr>
                                <td colspan='2'>
                                    <g:link action='aclObjectIdentitySearch' controller='aclObjectIdentity'
                                            params='[ownerSid: aclSid.id]'>View Associated OIDs</g:link>
                                </td>
                            </tr>
                            <tr>
                                <td colspan='2'>
                                    <g:link action='aclEntrySearch' controller='aclEntry'
                                            params='[sid: aclSid.id]'>View Associated ACL Entries</g:link>
                                </td>
                            </tr>
                    ...
                    <div style='float:left; margin-top: 10px;'>
                        <s2ui:submitButton elementId='update' form='aclSidEditForm'

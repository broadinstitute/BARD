	...
	<body>
		...
		<div id="show-assay" class="content scaffold-show" role="main">
			...
			<ol class="property-list assay">
				...
				<g:if test="${assayInstance?.assayTitle}">
				<li class="fieldcontain">
					<span id="assayTitle-label" class="property-label"><g:message code="assay.assayTitle.label" default="Assay Title" /></span>
					
						<span class="property-value" aria-labelledby="assayTitle-label"><g:fieldValue bean="${assayInstance}" field="assayTitle"/></span>

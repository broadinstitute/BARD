            ...
            <div class="row-fluid">
                ...
                <article class="span8">
                    ...
                    <dl>
                        ...
                        <dd>Think of your query cart as a quiet workspace, free of noise and clutter, where only the most interesting assay definitions, compounds and projects come together and your ideas take shape. Your cart will expand and contract, as you come and go between searches and drill downs into details using visualization tools such as the molecular spreadsheet.
                        </dd>


                        <dt>Hypothesis Generation</dt>
                        <dd>Tools such as the Linked Hierarchy Visualization may lead you to new questions and hypotheses. Because BARD has made it possible to examine specific projects in detail, you can now consider the ideas that drive large collections of assays and experiments.
                        </dd>
                    </dl>

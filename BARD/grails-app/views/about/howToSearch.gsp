        ...
        <div class="hero-area">
            <div class="row-fluid">
                ...
                <article class="span8">
                    ...
                    <p>
                    <ul>
                        <li><a href="bardtext_rdm.html">Research Data Management</a></li>
                        <li><a href="bardtext_history.html">History</a></li>
                        <li><a href="bardtext_developmentTeam.html">Development Team</a></li>
                        <li><a href="bardtext_architecture.html">Architecture and Design</a></li>
                    </ul>
                </p>

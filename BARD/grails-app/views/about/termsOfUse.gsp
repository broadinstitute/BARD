...
<div class="search-panel">
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <article class="span8 head-holder"><h2>Terms and conditions</h2></article>
            <aside class="span2"></aside>
        </div>
        ...
        <div class="lowkey-hero-area">
            <div class="row-fluid">
                ...
                <article class="span8">
                    ...
                    <p>
                    Material provided in BARD is protected by copyright law.  With the exception of the BARD Software, the material provided within BARD is available under a Creative Commons BY license (http://creativecommons.org/licenses/by/3.0/). The attribution requirements for BARD Plug-ins must include both the BARD Contributors and the author(s) of the plug-in, as noted in the plug-in manifest.  However, BARD Software is governed by the license agreement associated with the respective module of source code.
                    </p>

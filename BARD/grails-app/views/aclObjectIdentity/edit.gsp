            ...
            <s2ui:form width='100%' height='310' elementId='formContainer'
                ...
                <g:form action='update' name='aclObjectIdentityEditForm'>
                        ...
                        <table>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="aclClass"><g:message code="aclObjectIdentity.aclClass.label"
                                                                     default="AclClass"/></label>
                                </td>
                                <td valign="top"
                                    class="value ${hasErrors(bean: aclObjectIdentity, field: 'aclClass', 'errors')}">
                                    <g:select name="aclClass.id" from="${classes}" optionKey="id"
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="owner.id"><g:message code="aclObjectIdentity.owner.label"
                                                                     default="Owner"/></label>
                                </td>
                                <td valign="top"
                                    class="value ${hasErrors(bean: aclObjectIdentity, field: 'owner', 'errors')}">
                            ...
                            <s2ui:checkboxRow name='entriesInheriting'
                                              labelCode='aclObjectIdentity.entriesInheriting.label'
                                              bean="${aclObjectIdentity}"
                                              labelCodeDefault='Entries Inheriting'
                                              value="${aclObjectIdentity?.entriesInheriting}"/>

                            <tr>
                                <td colspan='2'>
                                    <g:link action='aclEntrySearch' controller='aclEntry'
                                            params='[aclObjectIdentity: aclObjectIdentity.id]'>View Associated ACL Entries</g:link>
                                </td>
                            </tr>
                    ...
                    <div style='float:left; margin-top: 10px;'>
                        <s2ui:submitButton elementId='update' form='aclObjectIdentityEditForm'

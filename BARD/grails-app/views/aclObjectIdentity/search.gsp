                ...
                <g:form action='aclObjectIdentitySearch' name='aclObjectIdentitySearchForm'>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan='3'><g:textField name='objectId' size='50' maxlength='255'
                                                         value='${objectId}'/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan='3'><g:textField name='parent' size='50' maxlength='255'
                                                         value='${parent}'/></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            <td><g:message code='aclObjectIdentity.entriesInheriting.label'
                                           default='Entries Inheriting'/>:</td>
                            <g:radioGroup name='entriesInheriting' labels="['', '', '']" values="[1, -1, 0]"
                                          value='${entriesInheriting}'>
                                <td><%=it.radio%></td>
                            </g:radioGroup>
                        </tr>
                        <tr>
                            <td colspan='4'><s2ui:submitButton elementId='search' form='aclObjectIdentitySearchForm'
                    ...
                    <table>
                        ...
                        <tr>
                            <g:sortableColumn property="id"
                                              title="${message(code: 'aclObjectIdentity.id.label', default: 'ID')}"/>
                            <g:sortableColumn property="aclClass.className"
                                              title="${message(code: 'aclObjectIdentity.aclClass.label', default: 'AclClass')}"/>
                            <g:sortableColumn property="objectId"
                                              title="${message(code: 'aclObjectIdentity.objectId.label', default: 'Object ID')}"/>
                            <g:sortableColumn property="entriesInheriting"
                                              title="${message(code: 'aclObjectIdentity.entriesInheriting.label', default: 'Entries Inheriting')}"/>
                            <g:sortableColumn property="owner.sid"
                                              title="${message(code: 'aclObjectIdentity.owner.label', default: 'Owner')}"/>
                            <g:sortableColumn property="parent.id"
                                              title="${message(code: 'aclObjectIdentity.parent.label', default: 'Parent')}"/>
                        </tr>
                        </thead>
                        ...
                        <g:each in="${results}" status="i" var="oid">
                            <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                ...
                                <td><g:link action="edit" controller='aclClass'
                                            id="${oid.aclClass.id}">${fieldValue(bean: oid.aclClass, field: "className")}</g:link></td>
                                ...
                                <td>
                                    <g:if test='${oid.owner && oid.owner.principal}'>
                                      ${fieldValue(bean: oid.owner, field: "sid")}
                                    </g:if>
                                    <g:if test='${oid.owner && !oid.owner.principal}'>
                                    ${fieldValue(bean: oid.owner, field: "sid")}
                                    </g:if>

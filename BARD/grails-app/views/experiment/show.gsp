        ...
        <section id="results-summary-header">
            ...
            <div class="row-fluid">
                <g:if test="${instance.ncgcWarehouseId && instance.experimentFiles}">
                    ...
                    <g:link controller="bardWebInterface" action="showExperiment" id="${instance.ncgcWarehouseId}">View all results for this experiment</g:link>
                </g:if>
                ...
                <g:else>
                    ...
                    <g:link controller="bardWebInterface" action="previewResults" id="${instance.id}">Preview results</g:link>
                </g:else>

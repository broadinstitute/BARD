                ...
                <g:form action='aclClassSearch' name='aclClassSearchForm'>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><g:textField name='className' size='60' maxlength='255' autocomplete='off'
                                             value='${className}'/></td>
                        </tr>
                        <tr><td colspan='2'>&nbsp;</td></tr>
                        <tr>
                            <td colspan='2'><s2ui:submitButton elementId='search' form='aclClassSearchForm'
                                                               messageCode='spring.security.ui.search' class="btn btn-primary"/>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                    ...
                    <table>
                        ...
                        <tr>
                            <g:sortableColumn property="className"
                                              title="${message(code: 'aclClass.className.label', default: 'Class Name')}"
                                              params="${queryParams}"/>
                        </tr>
                        </thead>
                        ...
                        <g:each in="${results}" status="i" var="aclClass">
                            <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                <td><g:link action="edit"
                                            id="${aclClass.id}">${fieldValue(bean: aclClass, field: "className")}</g:link></td>
                            </tr>
                        </g:each>
                        </tbody>
                    </table>

...
<head>
    ...
    <title>Register a New BARD User in Crowd</title>
</head>
        ...
        <div class="span12">
            ...
            <g:form action='register' name='registerForm'>
                <div class="control-group  fieldcontain ${hasErrors(bean: registerCommand, field: 'username', 'error')} required">
                    ...
                    <div class="controls">
                        <g:textField name="username" class="input-large" maxlength="250" required="" value="${registerCommand.username}"
                ...
                <div class="control-group  fieldcontain ${hasErrors(bean: registerCommand, field: 'firstName', 'error')} required">
                    ...
                    <div class="controls">
                        <g:textField name="firstName" class="input-large" maxlength="250" required="" value="${registerCommand.firstName}"
                ...
                <div class="control-group  fieldcontain ${hasErrors(bean: registerCommand, field: 'lastName', 'error')} required">
                    ...
                    <div class="controls">
                        <g:textField name="lastName" class="input-large" maxlength="250" required="" value="${registerCommand.lastName}"
                ...
                <div class="control-group  fieldcontain ${hasErrors(bean: registerCommand, field: 'email', 'error')} required">
                    ...
                    <div class="controls">
                        <input type="email" id="email" name="email" class="input-xxlarge" maxlength="250" required="" value="${registerCommand.email}"
                ...
                <div class="control-group  fieldcontain ${hasErrors(bean: registerCommand, field: 'password', 'error')} required">
                    ...
                    <div class="controls">
                        <g:passwordField name="password" class="input-xxlarge" maxlength="250" required="" value="${registerCommand.password}"
                ...
                <div class="control-group  fieldcontain ${hasErrors(bean: registerCommand, field: 'password2', 'error')} required">
                    ...
                    <div class="controls">
                        <g:passwordField name="password2" class="input-xxlarge" maxlength="250" required=""
                                         value="${registerCommand.password2}" placeholder="Enter Password Again"/>
                        <span class="help-inline">

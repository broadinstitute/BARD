...
<div class="control-group  fieldcontain ${hasErrors(bean: registerCommand, field: 'email', 'error')} required">
    ...
    <div class="controls">
        <input type="email" id="email" name="email" class="input-xxlarge" maxlength="250" required=""
...
<div class="control-group  fieldcontain ${hasErrors(bean: registerCommand, field: 'primaryGroup', 'error')} required">
    <label class="control-label" for="primaryGroup"><g:message code="register.primarygroup.label"
                                                               default="Primary Group"/>:</label>

    <div class="controls">
        <g:select required="" id="primaryGroup" name="primaryGroup.id" from="${bard.db.people.Role.list()}"
                  optionKey="id"
                  optionValue="displayName" noSelection="${['': '']}" value="${registerCommand?.primaryGroup?.id}"/>

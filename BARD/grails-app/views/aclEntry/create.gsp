                    ...
                    <div class="dialog">
                        ...
                        <table>
                            ...
                            <s2ui:textFieldRow name='aclObjectIdentity.id' labelCode='aclEntry.aclObjectIdentity.label'
                                               ...
                                               labelCodeDefault='AclObjectIdentity'
                                               value="${aclEntry?.aclObjectIdentity?.id}"/>
                            ...
                            <s2ui:checkboxRow name='auditSuccess' labelCode='aclEntry.auditSuccess.label'
                                              bean="${aclEntry}"
                                              labelCodeDefault='Audit Success' value="${aclEntry?.auditSuccess}"/>

                            <s2ui:checkboxRow name='auditFailure' labelCode='aclEntry.auditFailure.label'
                                              bean="${aclEntry}"
                                              labelCodeDefault='Audit Failure' value="${aclEntry?.auditFailure}"/>

                            <tr class="prop">
                                <td valign="top">
                                    <s2ui:submitButton elementId='create' form='aclEntryCreateForm'

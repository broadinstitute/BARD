                ...
                <g:form action='aclEntrySearch' name='aclEntrySearchForm'>
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan='3'><g:textField name='aclObjectIdentity' size='50' maxlength='255'
                                                         value='${aclObjectIdentity}'/></td>
                        </tr>
                        <tr>
                            <td><g:message code='aclEntry.aceOrder.label' default='Ace Order'/>:</td>
                            <td colspan='3'><g:textField name='aceOrder' size='50' maxlength='255'
                                                         value='${aceOrder}'/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <g:radioGroup name='auditSuccess' labels="['', '', '']" values="[1, -1, 0]"
                                          value='${auditSuccess}'>
                                <td><%=it.radio%></td>
                            </g:radioGroup>
                        </tr>
                        <tr>
                            ...
                            <g:radioGroup name='auditFailure' labels="['', '', '']" values="[1, -1, 0]"
                                          value='${auditFailure}'>
                                <td><%=it.radio%></td>
                            </g:radioGroup>
                        </tr>
                        <tr>
                            <td colspan='4'><s2ui:submitButton elementId='search' form='aclEntrySearchForm'
                                                               messageCode='spring.security.ui.search' class="btn btn-primary"/></td>
                        </tr>
                        </tbody>
                    </table>
                </g:form>
                    ...
                    <table>
                        ...
                        <tr>
                            <g:sortableColumn property="id"
                                              title="${message(code: 'aclEntry.id.label', default: 'ID')}"/>
                            <g:sortableColumn property="aclObjectIdentity.id"
                                              title="${message(code: 'aclEntry.aclObjectIdentity.label', default: 'AclObjectIdentity')}"/>
                            <g:sortableColumn property="aceOrder"
                                              title="${message(code: 'aclEntry.aceOrder.label', default: 'Ace Order')}"/>
                            <g:sortableColumn property="sid.id"
                                              title="${message(code: 'aclEntry.sid.label', default: 'SID')}"/>
                            <g:sortableColumn property="mask"
                                              title="${message(code: 'aclEntry.mask.label', default: 'Mask')}"/>
                            <g:sortableColumn property="granting"
                                              title="${message(code: 'aclEntry.granting.label', default: 'Granting')}"/>
                            <g:sortableColumn property="auditSuccess"
                                              title="${message(code: 'aclEntry.auditSuccess.label', default: 'Audit Success')}"/>
                            <g:sortableColumn property="auditFailure"
                                              title="${message(code: 'aclEntry.auditFailure.label', default: 'Audit Failure')}"/>
                        </tr>
                        </thead>
                        ...
                        <g:each in="${results}" status="i" var="entry">
                            <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                ...
                                <td><g:link action="edit" controller='aclObjectIdentity'
                                            id="${entry.aclObjectIdentity.id}">${entry.aclObjectIdentity.id}</g:link></td>
                                <td>${entry.aceOrder}</td>
                                <td><g:link action="edit" controller='aclSid'
                                            id="${entry.sid.id}">${fieldValue(bean: entry.sid, field: "sid")}</g:link></td>

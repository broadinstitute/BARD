...
%{--we need the absolute position here so descendant blocks can relate to it--}%
<div class="row-fluid" style="position: absolute; top: 0px; width: 100%; left: 0px">
    <div class="span12">

        %{--push down the whole linked-visualization frame to clear some room for the BARD header and footer--}%
        <div class="row-fluid" id="linkVisualizationContainer" style="position: absolute; top: 200px;">
            <div class="span12">

                <div class='stillLoadingSpinner' id="still_loading">
                    Still loading data. Please wait.
                    <g:img id="still_loading_image" dir="images" file="loading_icon.gif"
                           alt="please wait while data load"
                           height="50" width="50"/>
                </div>
                ...
                <div id="graphs">
                    <div id="pieCharts" class="pieCharts">
                        <div id="a0" class="pieChartContainer"
                             style="left: 0.5%; top: 10px; width: 21%;  height: 300px;">
                            <div id="a0-chart" class="pieChart">
                                <span class="graphTitle">Biological process</span>
                                <a class="reset" href="javascript:sharedStructures.resetBiologicalProcessPieChart();"
                        ...
                        <div id="a1" class="pieChartContainer"
                             style="left: 22.5%; top: 10px; width: 21%; height: 300px;">
                            <div id="a1-chart" class="pieChart">
                                <span class="graphTitle">Assay format</span>
                                <a class="reset" href="javascript:sharedStructures.resetAssayFormatPieChart();"
                                   style="display: none;">reset</a>
                                <span class="reset" style="display: none;"></span>
                        ...
                        <div id="a2" class="pieChartContainer"
                             style="left: 44.5%; top: 10px;  width: 21%; height: 300px;">
                            <div id="a2-chart" class="pieChart">
                                <span class="graphTitle">Protein class</span>
                                <a class="reset" href="javascript:sharedStructures.resetAssayIdDimensionPieChart();"
                                   style="display: none;">reset</a>
                                <span class="reset" style="display: none;"></span>
                        ...
                        <div id="a3" class="pieChartContainer"
                             style="left: 66.5%; top: 10px; width: 21%; height: 300px;">
                            <div id="a3-chart" class="pieChart">
                                <span class="graphTitle">Assay type</span>
                                <a class="reset" href="javascript:sharedStructures.resetAssayTypePieChart();"
                                   style="display: none;">reset</a>
                                <span class="reset" style="display: none;"></span>
                        ...
                        <div id="a4" class="resetDrillButtons"
                             style="left: 88.5%; top: 10px; width: 11.5%; height: 300px;">
                        </div>
                    </div>
                </div>
                ...
                <div id="suburst_container" class="container-fluid" style="position:absolute; left: 10px; top: 320px;">

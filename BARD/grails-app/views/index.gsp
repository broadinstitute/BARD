...
<div class="row-fluid">
    <div class="span8 offset2">
        ...
        <p>
            <a href="/BARD/assayDefinition/findById"><img
                    src="${resource(dir: 'images', file: 'magnifyingGlassIcon.png')}" alt="Find Exiting Assay"
                    title="Find Exiting Assay"/> Find an existing assay to edit or clone</a><br/> <br/>
            <g:link controller="project" action="create">
                <img src="${resource(dir: 'images', file: 'lightBulbIcon.png')}" alt="Create New Project"

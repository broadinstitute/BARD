...
TRUNCATE TABLE confidence_level_score;
TRUNCATE TABLE factor_component;
DELETE FROM confidence_level_factor;
truncate table ASSAY_CONTEXT_MEASURE ;
truncate table PROJECT_DOCUMENT ;
truncate table EXPRMT_CONTEXT_ITEM ;
truncate table EXPERIMENT_FILE ;
...
--INSERT INTO RESULT (RESULT_ID, RESULT_STATUS, PARENT_RESULT_ID, PARENT_CHILD_RELATIONSHIP, READY_FOR_EXTRACTION, EXPERIMENT_ID, RESULT_TYPE_ID, SUBSTANCE_ID, STATS_MODIFIER_ID, REPLICATE_NO, QUALIFIER, VALUE_NUM, VALUE_MIN, VALUE_MAX, VALUE_DISPLAY, VERSION, DATE_CREATED, LAST_UPDATED, MODIFIED_BY) select RESULT_ID, RESULT_STATUS, PARENT_RESULT_ID, PARENT_CHILD_RELATIONSHIP, READY_FOR_EXTRACTION, EXPERIMENT_ID, RESULT_TYPE_ID, SUBSTANCE_ID, STATS_MODIFIER_ID, REPLICATE_NO, QUALIFIER, VALUE_NUM, VALUE_MIN, VALUE_MAX, VALUE_DISPLAY, VERSION, DATE_CREATED, LAST_UPDATED, MODIFIED_BY from data_mig.RESULT;
...
INSERT INTO PERSON (PERSON_ID, USERNAME, email_address, ACCOUNT_EXPIRED, ACCOUNT_LOCKED, ACCOUNT_ENABLED, VERSION, DATE_CREATED, LAST_UPDATED, MODIFIED_BY) select PERSON_ID, USERNAME, email_address, ACCOUNT_EXPIRED, ACCOUNT_LOCKED, ACCOUNT_ENABLED, VERSION, DATE_CREATED, LAST_UPDATED, MODIFIED_BY from data_mig.PERSON;
...
INSERT INTO MEASURE (MEASURE_ID, ASSAY_ID, RESULT_TYPE_ID, PARENT_MEASURE_ID, PARENT_CHILD_RELATIONSHIP, ENTRY_UNIT_ID, STATS_MODIFIER_ID, VERSION, DATE_CREATED, LAST_UPDATED, MODIFIED_BY) select MEASURE_ID, ASSAY_ID, RESULT_TYPE_ID, PARENT_MEASURE_ID, PARENT_CHILD_RELATIONSHIP, ENTRY_UNIT_ID, STATS_MODIFIER_ID, VERSION, DATE_CREATED, LAST_UPDATED, MODIFIED_BY from data_mig.MEASURE;
...
INSERT INTO CONFIDENCE_LEVEL_FACTOR (CONFIDENCE_LEVEL_FACTOR_ID, FACTOR_NAME, PRECIDENCE, WEIGHTING, MIN_THRESHOLD, MAX_LEVEL, DESCRIPTION, SCORE_SQL, VERSION, DATE_CREATED, LAST_UPDATED, MODIFIED_BY) SELECT CONFIDENCE_LEVEL_FACTOR_ID, FACTOR_NAME, PRECIDENCE, WEIGHTING, MIN_THRESHOLD, MAX_LEVEL, DESCRIPTION, SCORE_SQL, VERSION, DATE_CREATED, LAST_UPDATED, MODIFIED_BY FROM data_mig.CONFIDENCE_LEVEL_FACTOR;
INSERT INTO FACTOR_COMPONENT (FACTOR_COMPONENT_ID, CONFIDENCE_LEVEL_FACTOR_ID, COMPONENT_NAME, COMPONENT_RATING, VERSION, DATE_CREATED, LAST_UPDATED, MODIFIED_BY) SELECT FACTOR_COMPONENT_ID, CONFIDENCE_LEVEL_FACTOR_ID, COMPONENT_NAME, COMPONENT_RATING, VERSION, DATE_CREATED, LAST_UPDATED, MODIFIED_BY FROM data_mig.FACTOR_COMPONENT;
COMMIT;
...
BEGIN
auditing_setup.update_settings;
DELETE FROM audit_setting WHERE table_name LIKE '%TREE';

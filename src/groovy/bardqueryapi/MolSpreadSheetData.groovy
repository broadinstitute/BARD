...
class MolSpreadSheetData {
    ...
    MolSpreadSheetData(String s)  {
        ...
        mssData.put("0_1", new MolSpreadSheetCell("2",MolSpreadSheetCellType.string))
        mssData.put("1_1", new MolSpreadSheetCell("3888712",MolSpreadSheetCellType.identifier))
        mssData.put("2_1", new MolSpreadSheetCell("0.0000543",MolSpreadSheetCellType.numeric))
        mssData.put("3_1", new MolSpreadSheetCell("0.00000566",MolSpreadSheetCellType.numeric))
        mssData.put("4_1", new MolSpreadSheetCell("0.00000101",MolSpreadSheetCellType.numeric))
        mssData.put("0_2", new MolSpreadSheetCell("3",MolSpreadSheetCellType.string))
        mssData.put("1_2", new MolSpreadSheetCell("3888713",MolSpreadSheetCellType.identifier))
        mssData.put("2_2", new MolSpreadSheetCell("0.0000657",MolSpreadSheetCellType.numeric))
        mssData.put("3_2", new MolSpreadSheetCell("0.00000721",MolSpreadSheetCellType.numeric))
        mssData.put("4_2", new MolSpreadSheetCell("0.00000093",MolSpreadSheetCellType.numeric))

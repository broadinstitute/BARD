...
-- if these procedures don't exist, these statements will fail
DROP PROCEDURE update_context_name;
DROP PROCEDURE update_project_context_name;
DROP PROCEDURE update_assay_short_name;

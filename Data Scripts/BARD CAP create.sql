...
CREATE TABLE RESULT_HIERARCHY(
    ...
    Last_Updated           TIMESTAMP(6),
    MODIFIED_BY            VARCHAR2(40),
    CONSTRAINT CK_RESULT_HIERARCHY_TYPE CHECK (Hierarchy_Type in('Derived from', 'has Child', 'has Sibling')),
...
CREATE INDEX FK_DICTIONARY_TREE_PARENT ON DICTIONARY_TREE(NODE_ID)
;
--
...
CREATE INDEX FK_STATS_MODIFIER_PARENT ON STATS_MODIFIER_TREE(NODE_ID)
;
--

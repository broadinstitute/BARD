...
CREATE TABLE PRJCT_EXPRMT_CONTEXT_ITEM(
    Prjct_Exprmt_Context_Item_ID    NUMBER(19, 0)     NOT NULL,
    PRJCT_EXPRMT_CONTEXT_ID         NUMBER(19, 0)     NOT NULL,
    ...
    CONSTRAINT PK_PRJCT_EXPRMT_CONTEXT_ITEM PRIMARY KEY (Prjct_Exprmt_Context_Item_ID)
)
;



COMMENT ON COLUMN PRJCT_EXPRMT_CONTEXT_ITEM.VALUE_DISPLAY IS 'This is not a general text entry field, rather it is an easily displayable text version of the other value columns'
;
--
-- TABLE: PROJECT
--
...
CREATE INDEX FK_PRJCT_EXPRMT_CNTXT_ITM_ATTR ON PRJCT_EXPRMT_CONTEXT_ITEM(ATTRIBUTE_ID)
;
--
-- INDEX: FK_PRJCT_EXPRMT_CNTXT_ITM_VAL
--

CREATE INDEX FK_PRJCT_EXPRMT_CNTXT_ITM_VAL ON PRJCT_EXPRMT_CONTEXT_ITEM(VALUE_ID)
;
--
-- INDEX: FK_PRJCT_EXPRMT_CNTXT_ITM_CNTX
--

CREATE INDEX FK_PRJCT_EXPRMT_CNTXT_ITM_CNTX ON PRJCT_EXPRMT_CONTEXT_ITEM(PRJCT_EXPRMT_CONTEXT_ID)
;
--
...
ALTER TABLE PRJCT_EXPRMT_CONTEXT_ITEM ADD CONSTRAINT FK_PRJ_EXPT_CNTXT_ITM_ATTR
    FOREIGN KEY (ATTRIBUTE_ID)
    REFERENCES ELEMENT(ELEMENT_ID)
;

ALTER TABLE PRJCT_EXPRMT_CONTEXT_ITEM ADD CONSTRAINT FK_PRJ_EXPT_CNTXT_ITM_PRJ_EXPT
    FOREIGN KEY (PRJCT_EXPRMT_CONTEXT_ID)
    REFERENCES PRJCT_EXPRMT_CONTEXT(PRJCT_EXPRMT_CONTEXT_ID)
;

ALTER TABLE PRJCT_EXPRMT_CONTEXT_ITEM ADD CONSTRAINT FK_PRJ_EXPT_CNTXT_ITM_VAL
    FOREIGN KEY (VALUE_ID)
    REFERENCES ELEMENT(ELEMENT_ID)
;

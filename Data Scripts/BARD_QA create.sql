...
--
-- Date Created : Thursday, May 17, 2012 19:27:11
...
-- 
-- TABLE: BARD_QA.LABORATORY 
--

CREATE TABLE BARD_QA.LABORATORY(
    NODE_ID           NUMBER(19, 0)     NOT NULL,
    PARENT_NODE_ID    NUMBER(19, 0),
...
;
-- 
-- INDEX: BARD_QA.UI_ELEMENT_LOWER_LABEL 
--

CREATE UNIQUE INDEX BARD_QA.UI_ELEMENT_LOWER_LABEL ON BARD_QA.ELEMENT(LOWER("LABEL"))
TABLESPACE BARD_DAT
;
-- 
...
;
-- 
-- INDEX: BARD_QA.FK_MEASURE_ASSAY 
--

CREATE INDEX BARD_QA.FK_MEASURE_ASSAY ON BARD_QA.MEASURE(ASSAY_ID)
;
-- 
-- INDEX: BARD_QA.FK_MEASURE_PARENT_MEASURE_ID 
--

CREATE INDEX BARD_QA.FK_MEASURE_PARENT_MEASURE_ID ON BARD_QA.MEASURE(PARENT_MEASURE_ID)
;
-- 
...
ALTER TABLE BARD_QA.LABORATORY ADD CONSTRAINT FK_LABORATORY_PARENT_NODE_ID 
    FOREIGN KEY (PARENT_NODE_ID)
    REFERENCES BARD_QA.LABORATORY(NODE_ID)
;
...
ALTER TABLE BARD_QA.MEASURE ADD CONSTRAINT FK_MEASURE_ASSAY 
    FOREIGN KEY (ASSAY_ID)
    REFERENCES BARD_QA.ASSAY(ASSAY_ID)
;
...
ALTER TABLE BARD_QA.MEASURE ADD CONSTRAINT FK_MEASURE_PARENT_MEASURE_ID 
    FOREIGN KEY (PARENT_MEASURE_ID)
    REFERENCES BARD_QA.MEASURE(MEASURE_ID)
;
...
ALTER TABLE BARD_QA.STAGE ADD CONSTRAINT FK_STAGE_PARENT_NODE_ID 
    FOREIGN KEY (PARENT_NODE_ID)
    REFERENCES BARD_QA.STAGE(NODE_ID)
;

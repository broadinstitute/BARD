...
update ASSAY_CONTEXT set context_type = 'Unclassified' where context_group in ('unclassified>','Unclassified') or context_group is null;
update EXPRMT_CONTEXT set context_type = 'Unclassified' where context_group in ('unclassified>','Unclassified') or context_group is null;
update PRJCT_EXPRMT_CONTEXT set context_type = 'Unclassified' where context_group in ('unclassified>','Unclassified') or context_group is null;

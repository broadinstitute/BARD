...
;
ALTER TABLE PRJCT_EXPRMT_CNTXT_ITEM ADD CONSTRAINT UK_PRJCT_EXPRMT_CNTXT_ITM_ORD UNIQUE(PRJCT_EXPRMT_CONTEXT_ID, DISPLAY_ORDER) INITIALLY DEFERRED DEFERRABLE
;

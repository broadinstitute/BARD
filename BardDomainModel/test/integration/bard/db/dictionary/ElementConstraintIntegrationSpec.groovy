 ...
 */
@Unroll
class ElementConstraintIntegrationSpec extends IntegrationSpec {

    Element domainInstance
    Element unitElement
    ...
    void "test unit constraints #desc unit: '#valueUnderTest'"() {
        ...
        'valid value' | "foo"                             | false | null

        'valid value' | createString(UNIT_MAX_SIZE, 'u')  | true  | null
        'null value'  | null                              | true  | null
    }
